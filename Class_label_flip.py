...
# -*- coding: utf-8 -*-
"""
Created on Sat Sep  5 20:54:52 2020

@author: sylviachadha
"""


# Compounding effect of class label

# We keep the ratio as well as dataset size same but we vary the amount
# of % of labels flipped (majority label as minority and vice versa)

# Same class imbalance but different amount of label noise
