...
# -*- coding: utf-8 -*-
"""
Created on Sun Sep 20 16:15:42 2020
...
# To handle imbalance we use Cost Sensitive version of xgboost
# the hyperparamter to tune to handle class imbalance is scale pos weight

# First we estimate the value of scale pos weight
...
# Apprach - Tuning the class weighting hyperparameter which is 
# scale pos weight
